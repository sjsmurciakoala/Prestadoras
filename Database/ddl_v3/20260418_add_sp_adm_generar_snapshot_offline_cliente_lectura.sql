-- =============================================================================
-- Snapshot offline V3 del motor tarifario por cliente
-- Fecha: 2026-04-18
-- Requiere:
...
--
-- Alcance:
--   - devuelve un paquete JSON por cliente con las reglas vigentes del motor
--     para uso offline en app lectora
--   - incluye servicios base y derivados con todas sus reglas activas
--   - no calcula montos finales; solo entrega el snapshot de reglas
-- =============================================================================
...
BEGIN
    ...
    SELECT
        ...
        jsonb_build_object(
            'contract_version', 'OFFLINE_SNAPSHOT_V3_1',
