-- 20260417_add_sp_adm_calcular_factura_lectura.sql
-- Calcula la factura de lectura usando el motor tarifario nuevo sin persistir factura.

CREATE OR REPLACE FUNCTION public.sp_adm_calcular_factura_lectura(
    p_company_id bigint,
    p_anio integer,
    p_mes integer,
    p_cliente_id bigint,
...
RETURNS TABLE(
    ...
    condicion_lectura_aplicada text,
    lectura_anterior numeric,
    lectura_actual_efectiva numeric,
    consumo_facturable numeric,
    numero_factura text,
    id_cai integer,
    correlativo_cai integer,
    fecha_factura date,
