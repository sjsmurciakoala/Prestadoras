-- ============================================================
-- FIX 2026-05-20 - descuento tercera edad en snapshot offline V3
-- ============================================================
-- sp_adm_generar_snapshot_offline_cliente_lectura no incluia la regla del
-- descuento tercera edad. El app descargaba el snapshot sin descuento y
-- facturaba sin el; al sincronizar, sp_adm_calcular_factura_lectura recalculaba
-- CON descuento -> SYNC_CONFLICT sistematico para clientes tercera edad.
--
-- Fix: el snapshot agrega un servicio DESCUENTO con regla DESCUENTO_PORCENTAJE
-- (% del ajuste TERCERA_EDAD_DOMESTICO sobre AGUA_POTABLE, con tope). El app
-- (ConstruirFacturaV3DesdeOfflineSnapshot) reconoce DESCUENTO_PORCENTAJE y lo
-- aplica como linea negativa visible en la factura.
-- ============================================================
