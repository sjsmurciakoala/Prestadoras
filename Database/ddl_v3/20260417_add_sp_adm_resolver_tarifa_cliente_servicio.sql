-- =============================================================================
-- Resolver de prueba: motor tarifario por cliente_servicio
-- Fecha: 2026-04-17
-- Requiere:
...
--
-- Alcance:
--   - resuelve el cuadro tarifario vigente para un registro de adm_cliente_servicio
--   - devuelve las reglas aplicadas y el monto calculado por regla
--   - soporta APC:
--       * MONTO_FIJO
...
--
-- Nota:
--   - PORCENTAJE_SERVICIO y REGLA_ESPECIAL quedan listos para extensiones futuras
--     pero no se calculan en esta primera version.
-- =============================================================================
...
BEGIN
    ...
    SELECT
        ...
        CASE
            ...
            THEN 'Regla porcentual pendiente de integrar con servicio base'::text
...
IS 'Resuelve el cuadro tarifario y devuelve las reglas aplicadas para un registro de adm_cliente_servicio en una fecha dada.';
