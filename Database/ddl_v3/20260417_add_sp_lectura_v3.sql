-- 20260417_add_sp_lectura_v3.sql
-- Registra lectura, factura y transaccion comercial usando el motor tarifario V3.

CREATE OR REPLACE FUNCTION public.sp_lectura_v3(
    p_company_id bigint,
    p_anio integer,
    p_mes integer,
    p_ciclo character varying DEFAULT NULL,
    p_clave character varying DEFAULT NULL,
    p_contador character varying DEFAULT NULL,
    p_fecha_lectura date DEFAULT current_date,
    p_usuario character varying DEFAULT NULL,
    p_lectura_actual numeric DEFAULT NULL,
    p_ser3 character DEFAULT NULL,
    p_ser4 character DEFAULT NULL,
    p_observacion character varying DEFAULT NULL,
    p_condicion_lectura character varying DEFAULT 'N',
    p_lectura_promedio numeric DEFAULT NULL,
    p_numero_factura character varying DEFAULT NULL,
    p_correlativo_cai integer DEFAULT NULL,
    p_id_cai integer DEFAULT NULL,
    p_tienemedidor character DEFAULT NULL,
    p_informativo character varying DEFAULT NULL,
    p_imagen bytea DEFAULT NULL,
    p_categoria character DEFAULT NULL,
    p_lectura_uuid character varying DEFAULT NULL
)
RETURNS TABLE(
    success boolean,
    codigo text,
    ...
    consumo numeric,
    subtotal numeric,
    subtotal_ajustes numeric,
    saldos_anteriores numeric,
    recargos numeric,
    total numeric,
    taservi1 numeric,
    taservi2 numeric,
