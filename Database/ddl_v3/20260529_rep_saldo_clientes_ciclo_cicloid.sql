-- =============================================================================
-- Reporte: Saldo de clientes por ciclo (con filtro por Ciclo)
...
DROP FUNCTION IF EXISTS public.rep_saldo_clientes_ciclo(bigint, date, date, bigint);
DROP FUNCTION IF EXISTS public.rep_saldo_clientes_ciclo(bigint, date, date, integer);
...
COMMENT ON FUNCTION public.rep_saldo_clientes_ciclo(bigint, date, date, bigint) IS
'Resumen totalizado por ciclo con saldo anterior, movimientos del periodo y conteos de clientes. Soporta filtrado por un ciclo específico.';
