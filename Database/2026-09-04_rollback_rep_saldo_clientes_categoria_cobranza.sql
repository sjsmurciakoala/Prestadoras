-- ROLLBACK del paso 1 del runbook 2026-09-04.
-- Definicion EXACTA que tenia siad_v4 antes de aplicar la optimizacion,
-- extraida del servidor el 2026-09-05 08:32.
-- NO es un paso de aplicacion: correr SOLO si hay que volver atras.
