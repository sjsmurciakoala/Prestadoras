...
public partial class adm_nota_debito
{
    ...
    public decimal monto_aumentar { get; set; }

    public decimal isv_aumentar { get; set; }
    ...
    public virtual cfg_motivo_aumento motivo_aumento { get; set; } = null!;

    public virtual ICollection<adm_nota_debito_detalle> detalles { get; set; } = new List<adm_nota_debito_detalle>();
}
