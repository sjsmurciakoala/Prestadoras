...
/// <summary>
/// Último número de orden de compra emitido por empresa (la PK ES el <c>company_id</c>,
/// mismo patrón que <see cref="alm_config_inventario"/>).
/// <para>
...
/// mismo número y chocarían contra <c>uq_alm_orden_compra_numero</c>.
/// </para>
/// </summary>
public partial class alm_orden_compra_correlativo : ICompanyScopedEntity
{
