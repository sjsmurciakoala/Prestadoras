...
public partial class con_plantilla_partida_dtl : ICompanyScopedEntity
{
    ...
    public string line_mode { get; set; } = "FIXED";

    public string? entry_side { get; set; }

    public string? detail_account_field { get; set; }

    public string? detail_amount_field { get; set; }

    public string? detail_description_field { get; set; }
